// JavaScript trang chi tiết - Cấu trúc BEM
// Xử lý các tương tác trên trang chi tiết bài viết

document.addEventListener("DOMContentLoaded", function () {
  // ========================================
  // TƯƠNG TÁC HEADER
  // Xử lý các sự kiện trên thanh header
  // ========================================

  // Bật/tắt chọn ngôn ngữ
  const languageSelector = document.querySelector(".language-selector");
  if (languageSelector) {
    languageSelector.addEventListener("click", function () {
      console.log("Language selector clicked");
      // TODO: Thêm dropdown chọn ngôn ngữ
    });

    // Xử lý phím Enter/Space cho accessibility
  ...
  // Đánh dấu link đang active trong menu chính
  const mainNavLinks = document.querySelectorAll(".main-nav__link");
  mainNavLinks.forEach((link) => {
    link.addEventListener("click", function (e) {
      e.preventDefault(); // Xóa dòng này khi có navigation thật

      // Bỏ trạng thái active của tất cả link
      ...
      // TODO: Thêm chức năng điều hướng thật
    });
  });
  ...
  if (loginBtn) {
    loginBtn.addEventListener("click", function (e) {
      e.preventDefault(); // Xóa khi có chức năng đăng nhập
      console.log("Login button clicked");
      // TODO: Thêm modal hoặc redirect đăng nhập
    });
  }

  // Bật/tắt dropdown trích dẫn
  ...
  if (citationDropdown) {
    citationDropdown.addEventListener("click", function () {
      ...
      // Thêm chức năng dropdown nếu cần
    });
  }
  ...
  tocItems.forEach((item) => {
    item.addEventListener("click", function () {
      ...
      // Thêm cuộn mượt đến phần tương ứng nếu cần
    });
  });

  // Xử lý các nút trên thanh sidebar
  const actionButtons = document.querySelectorAll(".action-sidebar__btn");
  actionButtons.forEach((button) => {
    button.addEventListener("click", function () {
      console.log("Action button clicked");
      // Thêm xử lý cụ thể cho từng nút
    });
  });

  // ========================================
  // CHUYỂN TAB BÀI VIẾT LIÊN QUAN
  // Xử lý chuyển tab trong phần bài viết liên quan
  // ========================================
  ...
  postTabs.forEach((tab) => {
    tab.addEventListener("click", function () {
      ...
      // TODO: Tải bài viết theo loại tab
  ...
  // ========================================
  // TƯƠNG TÁC TAG TỪ KHÓA
  // Xử lý click vào các tag từ khóa
  // ========================================
  ...
  keywordTags.forEach((tag) => {
    tag.addEventListener("click", function () {
      ...
      // TODO: Thêm lọc hoặc điều hướng theo từ khóa
    });
  });
